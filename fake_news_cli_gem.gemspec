...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{This gem scrapes FactCheck.org's /fake-news url.}
  spec.description   = %q{Quickly view the 10 latest FactCheck.org/fake-news articles using this Ruby CLI Gem.}
